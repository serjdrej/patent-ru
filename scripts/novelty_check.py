...
def cmd_symbols(a) -> int:
    ...
    if not found:
        print("обозначений названных форм (латиница с подчёркиванием/Δ, "
              "вида Zant/Z0) не найдено — кириллица, одиночные буквы и "
              "греческие без Δ этим поиском не охвачены")
        return 0
